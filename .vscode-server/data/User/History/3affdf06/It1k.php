...
class RepoUser extends Repo{
    ...
    public function getInterventionsParIntervenantAvecStatut($idIntervenant) {
        // Requête pour récupérer les interventions et leur statut de suivi associées à l'idIntervenant
        ...
        // Récupération des interventions et leur statut de suivi sous

...
class RepoUser extends Repo{
    ...
    $sql = "SELECT u.idu, u.nom, u.prenom, r.nom_role
            ...
            WHERE u.idu = :id"; // Modifiez ici pour cibler l'utilisateur spécifique par son ID
    $sth = $this->link->prepare($sql);
    $sth->bindValue(':id', $id, \PDO::PARAM_INT); // Assurez-vous que le paramètre lié correspond à l'ID de l'utilisateur
    $sth->execute();

...
class RepoUser extends Repo{
    ...
    public function addIntervention($id_int, $idu) {
        $sql = INSERT INTO intervention (id_intervenant, id_client, id_admin, id_standardiste, id_urgence, id_suivi, nom_intervention, details_intervention, date_cre_int)
        SELECT id_intervenant, ID_DU_CLIENT, id_admin, id_standardiste, id_urgence, ID_SUIVI_INITIAL, nom_intervention, details_intervention, CURRENT_TIMESTAMP
        FROM intervention
